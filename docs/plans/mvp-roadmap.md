...
| M5 | E | 멀티게임: 포트 졸업 → 디스패치 seam 포트화 → 스컬킹(2~8인) | 🔶 진행 중 — S0 설계(D-97)·S1 포트 추출(D-98)·S2 인원 가변(D-99)·S3 룰 명세(D-100)·S4 스컬킹 도메인(D-101, 순수 엔진 275건) 완료, 남은 것 S5 통합·S6 클라. 실행 단위 `docs/plans/multi-game-sessions.md` |
